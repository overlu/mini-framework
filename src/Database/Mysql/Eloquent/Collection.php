...
class Collection extends BaseCollection implements QueueableCollection
{
     ...
     */
    public function find(mixed $key, mixed $default = null): Model|static|null
    {
     ...
     * @return void
     */
    protected function loadMissingRelation(Collection $models, array $path): void
    {
     ...
     * @return array
     */
    public function getDictionary(ArrayAccess|array $items = null): array
    {
